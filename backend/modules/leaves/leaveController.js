...
exports.approveLeave = async (req, res) => {
    ...
    // 👉 AUTO CREATE leave balance (FIX for SELF/admin)

    const defaultLeaves = 12;

    await pool.query(
        `INSERT INTO leave_balances (employee_id, leave_type, total_leaves, used_leaves, remaining_leaves)
         VALUES ($1, $2, $3, 0, $3)`,
        [employee_id, leave_type, defaultLeaves]
    );
    ...
    balanceCheck.rows = newBalance.rows;
}
