...
<h1 className="display-4 fw-bold" style={{ fontFamily: "'Ubuntu', sans-serif" }}>
  ...
  <span style={{ color: "var(--primary)" }}>
    {s.title ? s.title.split(" ").slice(-1)[0] : "Capabilities"}
          ...
          <p className=" lead" style={{ fontFamily: "'Ubuntu', sans-serif", color: "var(--textSecondary)" }}>
        ...
        <div className="p-lg-5 p-md-5 row g-lg-5 g-md-5 g-3">
          ...
          onMouseLeave={(e) => {
            ...
            e.currentTarget.style.boxShadow = "none";
                ...
                <h5 className="fw-bold" style={{fontFamily: "'Ubuntu', sans-serif",color:"var(--text)"}}>{f.title}</h5>
                <p className=" small mb-0" style={{fontFamily: "'Ubuntu', sans-serif",color: "var(--textSecondary)"}}>{f.desc}</p>
              </div>
            </div>
          ))}
        </div>
