...
//     roles: ["employee"] 
//   },
// {name:"Settings" ,path:"/superadmin/saas/superadminsettingspage",icon:<Settings size={18}/>,roles:["company_admin","employee","super_admin"]},
...
const Sidebar = () => {
  ...
  const allItems = [
    ...
    { name: "Settings", path: "/superadmin/settings", icon: <Settings size={18} />, roles: ["super_admin", "software_owner"] },
