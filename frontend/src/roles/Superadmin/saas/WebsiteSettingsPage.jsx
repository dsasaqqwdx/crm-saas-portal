...
import {
  ...
  ChevronRight, Save, CheckCircle, AlertCircle, Upload
} from "lucide-react";
...
const sectionDivider = {
  ...
  letterSpacing: "0.08em", borderBottom: "1px solid #e0e7ff",
...
// ── Logo Upload — uses currentLogo prop directly from DB, no local state ──────
function LogoUpload({ currentLogo, onChange }) {
  const handleFile = (e) => {
    ...
    reader.onload = () => {
      onChange({ target: { name: "logo", value: reader.result } });
    };
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
        ...
        <div style={{ position: "relative" }}>
          {currentLogo ? (
            <img
              src={currentLogo}
              alt="logo"
              style={{ width: 70, height: 70, objectFit: "cover", borderRadius: "50%", border: "3px solid #e0e7ff" }}
            />
          ) : (
        ...
        <div>
          <label style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "9px 16px", background: "#f1f5f9", border: "1px solid #e2e8f0", borderRadius: 8, cursor: "pointer", fontSize: 13, color: "#374151", fontWeight: 500, transition: "background 0.15s" }}
          ...
          <p style={{ fontSize: 11, color: "#94a3b8", marginTop: 5, marginBottom: 0 }}>
            PNG, JPG or SVG · Max 2MB · Shown as circle
          </p>
        </div>
...
export default function WebsiteSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      await axios.put(
        `${API}/api/website-settings/${activeSection}`,
            ...
            <div style={{ maxWidth: 720 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
                <div>
                  ...
                  <p style={{ color: "#94a3b8", fontSize: 13, margin: "4px 0 0" }}>Changes here reflect live on the public website.</p>
                </div>
