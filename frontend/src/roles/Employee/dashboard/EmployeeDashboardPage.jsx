              ...
              >
                <div className="row align-items-center">
                  ...
                  <div className="col-12 col-lg-4 text-center mt-4 mt-lg-0">
                    ...
                    <div
                      className="mt-3 p-3 rounded-4 bg-white border text-start"
                    ...
                    >
                      ...
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span className="badge rounded-pill px-3 py-2"
                          style={{
                            background: attendance.check_in ? "#dcfce7" : "#f1f5f9",
                            color:      attendance.check_in ? "#15803d" : "#94a3b8",
                            fontSize: "0.78rem"
                          }}
                        >
                      ...
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span className="badge rounded-pill px-3 py-2"
                          style={{
                            background: attendance.check_out ? "#fee2e2" : "#f1f5f9",
                            color:      attendance.check_out ? "#dc2626" : "#94a3b8",
                            fontSize: "0.78rem"
                          }}
                        >
                      ...
                      <div className="d-flex gap-2">
                        ...
                        <button
                          ...
                          style={{
                            background:    canCheckIn && !attendance.check_in ? "#6366f1" : "#f1f5f9",
                            color:         canCheckIn && !attendance.check_in ? "#fff"    : "#94a3b8",
                            border:        "none",
                            borderRadius:  "10px",
                            fontSize:      "0.82rem",
                            padding:       "8px 0",
                            cursor:        canCheckIn && !attendance.check_in ? "pointer" : "not-allowed",
                            opacity:       canCheckIn && !attendance.check_in ? 1 : 0.55,
                          }}
                          disabled={!canCheckIn || !!attendance.check_in || attLoading}
